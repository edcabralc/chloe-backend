        ...
        <section class="section">
            <div class="container">
                <div class="container-tipo-acomodacao">
                    <h2>{{ titleH2 }}</h2>
                    <div v-for="(quarto, index) in getQuarto" @click="" class="container-titulos-acomodacao" :key="index">
                        <input class="item-check" type="radio" name="acomodacao" :id="quarto.titulo" :value="quarto.titulo" />
                            ...
                            <div class="add-servicos-content">
                                <ul>
                                    <li v-for="(valor, servico) in servicos" :key="servico" class="flex">
                                        <input type="checkbox" :name="servico" :id="servico" @change="addServico(servico)" />
