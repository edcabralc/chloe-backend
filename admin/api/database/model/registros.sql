...
INSERT INTO usuario (nome_usuario, email_usuario, password, nivel, status, last_login, updated_at, id)
VALUES 
('João da Silva', 'joao.silva@email.com', '123456', 'admin', 'ativo', NOW(), NOW(), 1),
('Maria Souza', 'maria.souza@email.com', '789012', 'user', 'ativo', NOW(), NOW(),2),
('Pedro Ferreira', 'pedro.ferreira@email.com', '345678', 'user', 'inativo', NOW(), NOW(),3),
('Lucas', 'lucas@gmail.com', '123456', 'administrador', 'ativo', NOW(), NOW(),4),
('Maria', 'maria@gmail.com', 'abcdef', 'usuário', 'ativo', NOW(), NOW(),5),
('Pedro', 'pedro@gmail.com', 'qwerty', 'usuário', 'inativo', NOW(), NOW(),6),
('Julia', 'julia@gmail.com', 'abc123', 'administrador', 'ativo', NOW(), NOW(),7),
('Rafael', 'rafael@gmail.com', 'senha123', 'usuário', 'ativo', NOW(), NOW(),8),
('Carla', 'carla@gmail.com', '123abc', 'administrador', 'inativo', NOW(), NOW(),9),
('Mariana', 'mariana@gmail.com', 'senhaabc', 'usuário', 'ativo', NOW(), NOW(),10);
